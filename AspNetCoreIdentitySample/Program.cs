...
namespace AspNetCoreIdentitySample
{
    public class Program
    {
        ...
        {
            var host = CreateHostBuilder(args).Build(); //yapici
            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                if (!db.Sehirler.Any())
                {
                    db.Sehirler.Add(new Sehir { Id = 1, sehirAd = "Konya" });
                    db.Sehirler.Add(new Sehir { Id = 2, sehirAd = "Balýkesir" });
                    db.Sehirler.Add(new Sehir { Id = 3, sehirAd = "Ankara" });
